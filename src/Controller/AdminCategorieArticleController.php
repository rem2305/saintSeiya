...
{
    #[Route('/', name: 'app_admin_categorie_article_index', methods: ['GET'])]
    public function index(CategorieArticleRepository $categorieArticleRepository): Response
    {
        return $this->render('admin_categorie_article/index.html.twig', [
            'categorie_articles' => $categorieArticleRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_admin_categorie_article_new', methods: ['GET', 'POST'])]
    public function new(Request $request, CategorieArticleRepository $categorieArticleRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_categorie_article_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('admin_categorie_article/new.html.twig', [
            'categorie_article' => $categorieArticle,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_categorie_article_show', methods: ['GET'])]
    public function show(CategorieArticle $categorieArticle): Response
    {
        return $this->render('admin_categorie_article/show.html.twig', [
            'categorie_article' => $categorieArticle,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_admin_categorie_article_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, CategorieArticle $categorieArticle, CategorieArticleRepository $categorieArticleRepository): Response
    {
        ...
        return $this->renderForm('admin_categorie_article/edit.html.twig', [
            'categorie_article' => $categorieArticle,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_categorie_article_delete', methods: ['POST'])]
